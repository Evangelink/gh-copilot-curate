...
//
//   - .copilot/agent-pack/manifest.yml      — declared intent (hand-curatable)
//   - .copilot/agent-pack/manifest.lock.yml — resolved state (generated; do not hand-edit)
//
...
type LockFile struct {
	...
	LocalHash    string `yaml:"localHash"`    // sha256 of the file as written by gh-agent-pack into .copilot/
	Mode         string `yaml:"mode"`         // POSIX-style octal, e.g. "0644"
}

// LoadManifest reads .copilot/agent-pack/manifest.yml under repoRoot. Returns
...
// LoadLock reads .copilot/agent-pack/manifest.lock.yml. Returns a zero-valued
...
const manifestHeader = `# .copilot/agent-pack/manifest.yml — declared skill/agent intent.
...
const lockHeader = `# .copilot/agent-pack/manifest.lock.yml — generated by gh-agent-pack.
