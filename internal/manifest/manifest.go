...
// that gh-skills writes into a target repository:
//
...
const (
	...
	// SkillsDir is the root directory under which gh-skills writes installed files.
	SkillsDir = ".skills"
	// ManagedBy is the marker written into the lock file so downstream tools
	// can detect that the directory is managed by gh-skills.
	ManagedBy = "gh-skills"
...
type LockFile struct {
	...
	LocalHash    string `yaml:"localHash"`    // sha256 of the file as written by gh-skills
...
# Run "gh skills sync" (or any "gh skills" mutating command) to apply.
`

const lockHeader = `# .skills/manifest.lock.yml — generated by gh-skills.
# Do not edit by hand: re-run "gh skills" commands to regenerate.
`
