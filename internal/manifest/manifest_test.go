		...
		Plugins: []LockPlugin{
			{
				...
				Install:      InstallConfig{Mode: ModeSummary},
				Files: []LockFile{
					{Path: ".copilot/plugins/z-plugin/skills/b/SKILL.md", UpstreamPath: "plugins/z-plugin/skills/b/SKILL.md", UpstreamHash: "sha256:b", LocalHash: "sha256:b", Mode: "0644"},
					{Path: ".copilot/plugins/z-plugin/skills/a/SKILL.md", UpstreamPath: "plugins/z-plugin/skills/a/SKILL.md", UpstreamHash: "sha256:a", LocalHash: "sha256:a", Mode: "0644"},
				},
			},
